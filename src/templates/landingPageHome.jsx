...
const HomePage = ({ data, children, pageContext }) => {
  ...
  const teamMembers = {
    ...
    members: [
      ...
      },
      {
        ...
        description: 'Dr. Rosines, MD, Baylor College of Medicine graduating at the top of his class. Medical Director of 7 Houston area emergency rooms. Board certified in Emergency Medicine.',
      },
      // ... more team members
    ],
  };
  ...
  return (
    <>
      ...
      <hr className='sectionhr'/>
      <AllServices services={servicesData}/> {/* This can easily be set to be city specific */}
      <Footer/>
    </>
  )
}
