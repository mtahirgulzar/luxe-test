...
// import Intro from '../components/LandingPages/IntroSpecific'
// import SocialProof from '../components/LandingPages/SocialProof'
import Treatments from '../components/LandingPages/TreatmentsPages'
...
{/* <SocialProof/> */}
<div className='treatmentPageHeader'>
{/* <br/>
<br/> */}
<Treatments treatmentsData={treatmentsWithImages}  pageContext={pageContext} />
</div>
{/* <ExceptionalMedicine/>
...
<AllServices services={pageContext.servicesData}/> */}
      ...
      */}
      <hr style={{ color: 'white', margin: '0', padding: '0', height: '3px' }}/>
      <Footer/>
    </>
  )
}
